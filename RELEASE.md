...
Dieses Dokument beschreibt den automatisierten Release-Prozess für die CloudStash - S3 Compatible Backup Integration.
...
- `custom_components/cloudstash/manifest.json`
- `SCHNELLSTART.md`
...
✓ Updated custom_components/cloudstash/manifest.json
...
ℹ Next steps:
  1. Create a GitHub release at: https://github.com/derolli1976/HomeassistantS3CompatibleBackup/releases/new?tag=v0.1.1
...
Bei Problemen:
1. Prüfe [GitHub Issues](https://github.com/derolli1976/HomeassistantS3CompatibleBackup/issues)
